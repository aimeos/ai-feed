...
/**
 * Job controller for product exports for Google Shopping.
 *
 * @package Controller
 * @subpackage Jobs
 */
...
{
	/** controller/jobs/product/export/google/name
	 * Class name of the used Google product export controller implementation
	 *
	 ...
	 *
	 *  \Aimeos\Controller\Jobs\Product\Export\Google\Standard
	 *
	 ...
	 *
	 *  controller/jobs/product/export/google/name = Myalgorithm
	 *
	...
	/** controller/jobs/product/export/google/decorators/excludes
	 ...
	 *
	 *  controller/jobs/product/export/google/decorators/excludes = array( 'decorator1' )
	 *
	 ...
	 * @see controller/jobs/product/export/google/decorators/global
	 * @see controller/jobs/product/export/google/decorators/local
	 */

	/** controller/jobs/product/export/google/decorators/global
	 ...
	 *
	 *  controller/jobs/product/export/google/decorators/global = array( 'decorator1' )
	 *
	 ...
	 * @since 2026.01
	 * @see controller/jobs/common/decorators/default
	 * @see controller/jobs/product/export/google/decorators/excludes
	 * @see controller/jobs/product/export/google/decorators/local
	 */

	/** controller/jobs/product/export/google/decorators/local
	 ...
	 * controller.
	 *
	 *  controller/jobs/product/export/google/decorators/local = array( 'decorator2' )
	 *
	...
	{
		return $this->context()->translate( 'controller/jobs', 'Google shopping export' );
	}
	...
	{
		return $this->context()->translate( 'controller/jobs', 'Exports products for Google Shopping' );
	}
	...
	public function run()
	{
		...
		foreach( $items as $item )
		{
			...
			{
				$logger->error( 'Google product export error: ' . $e->getMessage() . "\n" . $e->getTraceAsString(), 'product/export/google' );
				$this->mail( 'Google product export error', $e->getMessage() . "\n" . $e->getTraceAsString() );
			}
		}
	}
	...
	{
		/** controller/jobs/product/export/google/domains
		...
		return (array) $this->context()->config()->get( 'controller/jobs/product/export/google/domains', $default );
	}
	...
	protected function export( \Aimeos\MShop\Feed\Item\Iface $feedItem, \Aimeos\MShop\Locale\Item\Iface $locale ) : void
	{
		...
		if( ( $fh = tmpfile() ) === false ) {
			throw new \Aimeos\Controller\Jobs\Exception( sprintf( 'Unable to create temporary file for Google shopping export' ) );
		}

		try
		{
			if( fwrite( $fh, $this->header() ) === false ) {
				throw new \Aimeos\Controller\Jobs\Exception( sprintf( 'Unable to write header for Google shopping export to temporary file' ) );
			}
	...
	{
		/** controller/jobs/product/export/google/filename
		 ...
		 */
		return (string) $this->context()->config()->get( 'controller/jobs/product/export/google/filename', '%1$sd/%2$s.csv' );
	}
	...
	protected function header() : string
	{
		 ...
		 * @see controller/jobs/product/export/google/max-items
		 */
		$tplconf = 'controller/jobs/product/export/google/template-header';
		$default = 'product/export/google/items-header-standard';
	...
	{
		/** controller/jobs/product/export/google/max-items
		 ...
		 * @see controller/jobs/product/export/google/domains
		 */
		return (int) $this->context()->config()->get( 'controller/jobs/product/export/google/max-items', 1000 );
	}
	...
	protected function render( \Aimeos\Map $items, \Aimeos\MShop\Feed\Item\Iface $feedItem ) : string
	{
		 ...
		 * @see controller/jobs/product/export/google/max-items
		 */
		$tplconf = 'controller/jobs/product/export/google/template-items';
		$default = 'product/export/google/items-body-standard';
